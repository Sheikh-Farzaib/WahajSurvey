...
namespace WahajSurvey.Controllers
{
    public class SurveyController : Controller
    {
        ...
        public SurveyController(ICategoryRepository category, IItemRepository item, IBranchRepository branch, ISurveyRepository survey)
        {
        ...
        public async Task<IActionResult> SubmitSurvery(SubmittedDataDTO submittedAnswers)
        {
            try
            {
                ...
                var result = await _survey.CreateSurvery(submitAnswers);
